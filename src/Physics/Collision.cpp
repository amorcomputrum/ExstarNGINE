...
bool exstar::Collision::PointvsCircle(int px,int py,int cx,int cy,int cr){
	return cr > exstar::Distance(px,py,cx,cy);
}
...
bool exstar::Collision::LinevsPoint(float x1, float y1, float x2, float y2, float px, float py) {
...
exstar::ArrayList<int>* exstar::Collision::LinevsCircleLoc(float x1, float y1, float x2, float y2, float cx, float cy, float r) {
...
exstar::ArrayList<int>* exstar::Collision::LinevsLineLoc(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
...
exstar::ArrayList<int>* exstar::Collision::LinevsRectLoc(float x1, float y1, float x2, float y2, float rx, float ry, float rw, float rh, int d) {
