...
bool exstar::DetectCollision::PointvsRect(float px,float py,float rx,float ry,float w,float h){
	return (px >= rx && px <= rx + w && py >= ry && py <= ry + h);
}
bool exstar::DetectCollision::RectvsRect(int x1,int y1,int w1,int h1,int x2,int y2,int w2,int h2){
	return ((((x1+w1 > x2) && x1 < x2) || ((x1 < x2+w2) && (x1+w1 > x2))) && (((y1+h1 > y2) && y1 < y2) || ((y1 < y2+h2) && (y1+h1 > y2))));
}
bool exstar::DetectCollision::CirclevsRect(float cx, float cy, float radius, float rx, float ry, float w, float h) {
  float testX = cx;
  float testY = cy;
  if (cx < rx)         testX = rx;
...
bool exstar::DetectCollision::LinevsPoint(float x1, float y1, float x2, float y2, float px, float py) {
...
bool exstar::DetectCollision::LinevsCircle(float x1, float y1, float x2, float y2, float cx, float cy, float r) {
...
bool exstar::DetectCollision::LinevsLine(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
...
bool exstar::DetectCollision::LinevsRect(float x1, float y1, float x2, float y2, float rx, float ry, float rw, float rh) {
...
exstar::ArrayList<int>* exstar::DetectCollision::LinevsCircleLoc(float x1, float y1, float x2, float y2, float cx, float cy, float r) {
...
exstar::ArrayList<int>* exstar::DetectCollision::LinevsLineLoc(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
...
exstar::ArrayList<int>* exstar::DetectCollision::LinevsRectLoc(float x1, float y1, float x2, float y2, float rx, float ry, float rw, float rh, int d) {
