...
namespace exstar{
	class Collision{
		...
		static bool RectvsRect(int x1,int y2,int w1,int h1,int x2,int y2,int w2,int h2);
		...
		static ArrayList<int>* LinevsCircleLoc(float x1, float y1, float x2, float y2, float cx, float cy, float r);

		static ArrayList<int>* LinevsLineLoc(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4);

		static ArrayList<int>* LinevsRectLoc(float x1, float y1, float x2, float y2, float rx, float ry, float rw, float rh, int d);
	};
}